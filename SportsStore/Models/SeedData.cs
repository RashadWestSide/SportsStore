        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product { Name = "Soccer Ball", Description = "FIFA-approved size and weight", Category = "Soccer", Price = 19.75m },
                    ...
                    new Product { Name = "Unsteady Chair", Description = "Secretly give your opponent a disadvatage", Category = "Chess", Price = 29.95m },
